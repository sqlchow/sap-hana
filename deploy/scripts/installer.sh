...
then
    ...
    then
        ...
        echo "#########################################################################################"
        echo "#                                                                                       #"
        echo "#            $cyan The system has already been deployed and the statefile is in Azure $resetformatting       #"
        echo "#                                                                                       #"
        echo "#########################################################################################"
        echo ""
        if [ ! -n ${approve} ] 
...
then
    ...
    if echo "${outputs}" | grep "No outputs"; then
        ...
        if [ ! -n "${deployed_using_version}" ]; then
            ...
            echo "#########################################################################################"
            echo "#                                                                                       #"
            echo "# $cyanTerraform templates version:" $deployed_using_version "were used in the deployment$resetformatting "
            echo "#                                                                                       #"
            echo "#########################################################################################"
            echo ""
